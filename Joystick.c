...
static InputFunction getInputs;

/* This is the main entry point.  The client will call this from
   their main() and give the address of a function that will fill
   in the joystick inputs.
*/
void Joystick(InputFunction inf) {
	// the supplied function is stored for later
	getInputs=inf;
...
void GetNextReport(USB_JoystickReport_Input_t* const ReportData) {
	...
	/* the values will be filled in by the callback function that was given */
	getInputs(ReportData);
}
